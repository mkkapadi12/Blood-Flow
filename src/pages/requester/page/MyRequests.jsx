              ...
              <div className="flex flex-col md:flex-row md:items-center">
                ...
                <div className="bg-gray-950/50 p-5 border-t md:border-t-0 md:border-l border-gray-800 flex flex-row md:flex-col items-center justify-between md:justify-center gap-4 min-w-[200px]">
                  ...
                  <Button
                    asChild
                    size="sm"
                    className="w-full md:w-auto bg-gray-800 hover:bg-gray-700 text-white border-0 group-hover:bg-red-500/10 group-hover:text-red-400 transition-colors"
                  >
                    <Link
                      to={`/requester/requests/${request._id}`}
